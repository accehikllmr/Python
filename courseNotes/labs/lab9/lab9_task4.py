...
def intersecting_chars(my_str: str) -> List[str]:
    """
    Given a string of letters from the alphabet, which three distinct substrings separated by underscores,
    ...
    if "" in strings:
        ...
        # separating each string into its own set, containing one instance for each of its characters, in order to make intersection comparisons
