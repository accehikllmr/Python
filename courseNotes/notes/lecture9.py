...
modifying one list can affect the other (methods act on underlying references, hence affecting all object using them),
...
since tuples are immutable, neither can be modified and thus affect the other
'''
