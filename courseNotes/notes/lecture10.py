...
print(f"before function call:\t{s}\t\t{l}\t\t{d}")  # all collections before function call
modify_mutable()
print(f"after function call:\t{s}\t{l}\t{d}")  # all collections, being mutable objects, are modified following the function call

# PYTHON
'''
other languages require than elements in a collection are of the same data type, 
