...
with open('student_record.csv', 'r') as student_record:
    ...
    for student in range(len(students)):
        ...
        for info in range(len(students[student])):
            ...
            # removing new line character from all final elements in all collections
    ...
    for student in students:
        ...
        issue since accessing other class attribute - resolved by implementing class method for adding students
        '''
