...
print(f"before function call:\t{s}\t\t{l}\t\t{d}")  # all error_checking_and_collections before function call
modify_mutable()
print(f"after function call:\t{s}\t{l}\t{d}")  # all error_checking_and_collections, being mutable objects, are modified following the function call
