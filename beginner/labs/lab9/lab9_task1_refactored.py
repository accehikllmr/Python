...
def calculate_average(numbers_str: str) -> float:
    ...
    Traceback (most recent call last):
    ...
    AssertionError: challenges than the | symbol, argument passed to numbers_str parameter must contain digits
    """
    ...
    for num in numbers:
        ...
        assert num.strip().isdigit(), "challenges than the | symbol, argument passed to numbers_str parameter must contain digits"
